        ...
        switch(packet.t) {
            case 0x01: fly_mode = packet.v; 
                       ...
                       crcerr.b[0]=EEPROM.read(0); crcerr.b[1]=EEPROM.read(1);
                        Serial.print("CRC errors: "); Serial.println(crcerr.i);
#else
                   EEPROM.write(0,crcerr.b[0]); EEPROM.write(1,crcerr.b[1]);
#endif
...
void log() {
    ...
    if (!(loop_count%100)) {
        ...
        */
        ...
        Serial.print("\tay: "); Serial.print(mympu.accel[0]);
        Serial.print(" ap: "); Serial.print(mympu.accel[1]);
        Serial.print(" ar: "); Serial.print(mympu.accel[2]);
